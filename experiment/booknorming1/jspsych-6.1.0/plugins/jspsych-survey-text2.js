...
jsPsych.plugins['survey-text'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    // add submit button
    html += '<input type="submit" id="jspsych-survey-text-next" class="jspsych-btn" style="background-color:#d3d3d3;" value="'+trial.button_label+'"></input>';

    // show postamble text
    if(trial.postamble !== null){
      html += '<div id="jspsych-survey-text-postamble" class="jspsych-survey-text-postamble">'+trial.postamble+'</div>';
    }
