...
```{r characterplots,  fig.height = 3.8, fig.width = 3.8, fig.cap="Distribution across books of audience gender as a function of primary character gender. Colored points show individuals books. Dashed line shows grand mean of proportion female audience. Black points and ranges show mean and bootstrapped 95\\% percent confidence intervals for books of each primary character gender type.", cache = F}
