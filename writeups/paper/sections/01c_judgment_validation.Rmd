...
label_df <- data.frame(label = c("activity\nwords", 
                                 "description\nwords"),
                       x = c(3.3, 3.3),
                       y = c(3.18, 3.37))
...
ggplot(by_group_means, aes(x = gender_group, y = mean)) +
  ...
  scale_y_continuous(breaks = c(2.8, 3.0, 3.2, 3.4), 
                     label = c("2.8\n(male-\nbiased)",  "3.0" ,"3.2", "3.4\n(female-\nbiased)"),
                     limits = c(2.8, 3.49)) +
  ggtitle("Study 1c: Validation of book gender measure") +
