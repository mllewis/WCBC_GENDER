...
As a first step we asked adult English speakers to rate the genderedness of words in these books using a 5-point scale from masculine to feminine [@scott2019glasgow]. This procedure yields systematic data with good face validity: words such as "cuddle" and "pink" are rated as feminine, "axe" and "engine" as masculine, "exactly" and "nose" as neutral.
