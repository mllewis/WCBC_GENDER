...
As a first step we asked adult English speakers to rate the genderedness of words in these books using a 5-point scale from masculine to feminine [@scott2019glasgow]. This procedure yields systematic data with good face validity: words such as "axe" and "engine" as masculine, "cuddle" and "pink" are rated as feminine,"exactly" and "nose" as neutral.
...
Participants rated the gender of each word on a 1-5 scale with the intervals labeled “Very masculine,” “Somewhat masculine,” “Neither masculine nor feminine,” “Somewhat feminine,” and “Very feminine” (note that we operationalize gender as a continuum ranging from masculine to feminine throughout and use the terms "masculine" and "feminine" interchangebly with "male" and "female". This approach ignores many aspects of gender that are not critical to the present research question). The instructions did not provide definitions of masculine or feminine; raters were encouraged to use their own intuitions. Each participant rated `r pull(N_ratings_per_subject, min)`-`r pull(N_ratings_per_subject, max)` words. Words were quasirandomly assigned to participants to ensure that each word received at least 10 ratings; mean number of ratings per word was `r pull(N_ratings_per_word, mean)` (_SD_ = `r N_ratings_per_word$sd`). 
