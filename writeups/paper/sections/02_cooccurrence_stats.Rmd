...
In summary, these studies show that both adult word gender associations and specific gender stereotypes observed in behavioral studies with adults and children are reflected in the co-occurrence statistics of the children’s book corpus. These findings are broadly consistent with prior work showing similar biases in a historical corpus of children's books published around 1900 [@charlesworth2021gender],
