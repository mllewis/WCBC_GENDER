...
# paths
CORPORA_PATH <-  here("data/processed/iat/corpora/coca_sampled/sampled_coca_")
MODEL_OUT_PATH <- here("data/processed/iat/models/trained_sampled_coca/trained_sampled_coca_5_count_")
N_SAMPLES <- 10
