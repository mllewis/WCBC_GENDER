...
# paths
CORPORA_PATH <-  here("exploratory_analyses/5_IAT_tests/data/corpora/kidbook_sampled/sampled_kidbook_")
MODEL_OUT_PATH <- here("exploratory_analyses/5_IAT_tests/data/models/trained_sampled_kidbook/trained_sampled_kidbook_5_count_")
N_SAMPLES <- 10
